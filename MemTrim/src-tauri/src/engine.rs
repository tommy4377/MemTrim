...
use crate::memory::ops::{
    memory_info, optimize_combined_page_list, optimize_modified_page_list_with_stealth,
    optimize_registry_cache, optimize_standby_list_with_stealth, optimize_system_file_cache,
    optimize_working_set_with_stealth,
};
...
impl Engine {
        ...
        F: FnMut(u8, u8, String),
    {
        ...
        for (operation_name, display_name) in &area_operations {
            ...
            let handle = std::thread::spawn(move || {
                ...
                let result =
                    engine.execute_optimization(&operation_name_clone, use_indirect_syscalls_clone);
    ...
    fn execute_optimization(
        ...
        match operation_name {
            ...
            "StandbyList" => optimize_standby_list_with_stealth(false, use_indirect_syscalls),
            "StandbyListLowPriority" => {
                optimize_standby_list_with_stealth(true, use_indirect_syscalls)
            }
